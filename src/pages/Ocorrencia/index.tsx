...
const ComunicacaoEvento = () => {
    ...
    const passoHandlers = {
        ...
        handleChangeReferenciaLocalidade: (value) =>
            handleChange('passo1', 'referenciaLocalidade', value),
        handleChangeData: (value) => handleChange('passo1', 'data', value),
        handleChangeNomeVitima: (value) => handleChange('passo2', 'nomeVitima', value),
        handleChangeEmpresaEmpregadora: (value) =>
            handleChange('passo2', 'empresaEmpregadora', value),
        ...
        handleChangeCondicaoAcidentado: (value) =>
            handleChange('passo4', 'condicaoAcidentado', value),
                ...
                return (
                    <PassoUm
                        ...
                        handleChangeReferenciaLocalidade={
                            passoHandlers.handleChangeReferenciaLocalidade
                        }
                ...
                return (
                    <PassoDois
                        ...
                        handleChangeEmpresaEmpregadora={
                            passoHandlers.handleChangeEmpresaEmpregadora
                        }
                ...
                return (
                    <PassoQuatro
                        handleChangeCondicaoAcidentado={
                            passoHandlers.handleChangeCondicaoAcidentado
                        }
        ...
        <div>
            ...
            <div className="content-bar">
                ...
                <div className="content-bar-subtex">
                    Esta etapa o usuario sera capaz de adicionar um evento novo, preenchendo as
                    Informações abaixo
                </div>
            </div>
