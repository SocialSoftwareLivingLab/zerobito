        ...
        <div className="Contato">
            ...
            <div className="container-header">
                ...
                <div className="container-contato">
                    <div className="text">
                        Aqui o Coordenador Geral tem acesso aos materiais de formação como
                        cartilhas, vídeos, listas etc. Também podem solicitar formação específica
                    </div>
                </div>
            </div>
            <div className="search-container">
                ...
                <button className="search-container-observatorio" type="submit">
            ...
            <div className="cartilhas">
                ...
                <div className="lista-cartilhas"></div>
            </div>
            ...
            <div className="videos">
                ...
                <div className="lista-videos"></div>
            </div>
