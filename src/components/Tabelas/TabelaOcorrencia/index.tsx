        ...
        <div className="table-container">
            <div className="table-header">
                <h2>
                    ...
                    <Link to="/ocorrencia">
                        <button className="button-novo-evento">
                            {' '}
                            <IoBagAdd />
                ...
                <tbody>
                    {eventosPaginaAtual.map((evento) => (
                        <tr key={evento.id}>
                            ...
                            <td>
                                <span
                                    ...
                                    {evento.gravidade && (
                                        <>
                                            <GoInfo
                                                title={`Explicação do evento: ${evento.gravidade}`}
                                            />
                                        </>
                                    )}
                                </span>
                            ...
                            <td>{evento.status}</td>
                            <td>
                                <button className="button-tabela-aceitar" onClick={() => {}}>
                                    {' '}
            ...
            <div className="pagination">
                ...
                <span className="page-info">
                    {currentPage} / {Math.ceil(eventos.length / itemsPerPage)}
                </span>
            </div>
            {showCard && (
            ...
            {showMonitorCard && (
                <div className="card-overlay">
                    <div className="card">
                        ...
                        <button className="dias-monitoramento" onClick={closeMonitorCard}>
                            7 dias
                        </button>
                        <button className="dias-monitoramento" onClick={closeMonitorCard}>
                            30 dias
                        ...
                        <button className="close-button" onClick={closeMonitorCard}>
                            <IoMdCloseCircle />
                        </button>
                    </div>
                </div>
            ...
            {showEncaminharCard && (
                <div className="card-overlay">
                    <div className="card">
                        ...
                        <div className="guias">
                            <button className="botoes-guia" onClick={closeEncaminharCard}>
                                Cancelar
                            </button>
                            <button className="botoes-guia" onClick={closeEncaminharCard}>
                                <LiaPaperPlane /> Enviar
                            </button>
                        </div>
                    </div>
                </div>
